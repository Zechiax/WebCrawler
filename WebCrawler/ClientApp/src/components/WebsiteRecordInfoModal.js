...
export class WebsiteRecordInfoModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      validated: false,
  ...
  componentDidUpdate(prevProps) {
    if (
      this.mounted &&
      prevProps.tagsPresetValue !== this.props.tagsPresetValue
    ) {
      this.updateTagsState();
    }
  }
  ...
  updateTagsState = () => {
    const tags = this.props.tagsPresetValue
      ? this.props.tagsPresetValue.map((tag) => tag.name)
      : [];
    this.setState({
      tags: tags,
    });
              ...
              <Form.Group>
                ...
                >
                  {this.state.tags.map((tag, index) => (
                    <li
                      className="list-group-item flex-fill d-flex justify-content-between"
                      key={index}
                    >
                      <Chip
                        label={tag}
                      ...
                      <span className="float-right">
                        <button
                          ...
                          onClick={(event) =>
                            this.handleDeleteTag(index, event)
                          }
                        >
                          <Delete />
                        </button>
